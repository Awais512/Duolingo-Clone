...
import { useHeartModall } from "@/store/use-hearts-modal";
...
export const Quiz = ({
  ...
  const { open: openHeartsModal } = useHeartModall();
  const { open: openPracticeModal } = usePracticeModall();
